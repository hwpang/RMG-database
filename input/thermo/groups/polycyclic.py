...
""",
    thermo = ThermoData(
        Tdata = ([300, 400, 500, 600, 800, 1000, 1500], 'K'),
        Cpdata = ([-15.1388, -20.2162, -24.8238, -25.2883, -22.6568, -18.2674, -11.621], 'J/(mol*K)'),
        H298 = (97.1098, 'kJ/mol'),
        S298 = (243.417, 'J/(mol*K)'),
    ),
    shortDesc = """Fitted from thermo library values""",
    longDesc = 
"""
Fitted from species C=CC1CC12_CH_C=CCC2_4979 from multi_trays library.
""",
)
...
""",
    thermo = ThermoData(
        Tdata = ([300, 400, 500, 600, 800, 1000, 1500], 'K'),
        Cpdata = ([-15.1388, -20.2162, -24.8238, -25.2883, -22.6568, -18.0164, -11.621], 'J/(mol*K)'),
        H298 = (101.336, 'kJ/mol'),
        S298 = (243.417, 'J/(mol*K)'),
    ),
    shortDesc = """Fitted from thermo library values""",
...
""",
    thermo = ThermoData(
        Tdata = ([300, 400, 500, 600, 800, 1000, 1500], 'K'),
        Cpdata = ([-36.6096, -35.9223, -33.3008, -29.2617, -22.4912, -16.0363, -9.24136], 'J/(mol*K)'),
        H298 = (38.0013, 'kJ/mol'),
        S298 = (219.128, 'J/(mol*K)'),
    ),
    shortDesc = """Fitted from thermo library values""",
    longDesc = 
"""
Fitted from species s2_5_5_ene_1 from multi_trays library.
""",
)
...
""",
    thermo = ThermoData(
        Tdata = ([300, 400, 500, 600, 800, 1000, 1500], 'K'),
        Cpdata = ([-39.723, -38.8714, -36.4458, -32.0227, -23.3445, -15.5059, -6.95151], 'J/(mol*K)'),
        H298 = (26.9133, 'kJ/mol'),
        S298 = (201.107, 'J/(mol*K)'),
    ),
    shortDesc = """Fitted from thermo library values""",
    longDesc = 
"""
Fitted from species s2_5_6_ene_1 from multi_trays library.
""",
)
...
""",
    thermo = ThermoData(
        Tdata = ([300, 400, 500, 600, 800, 1000, 1500], 'K'),
        Cpdata = ([-28.5237, -30.4109, -31.4284, -28.7538, -23.499, -17.7221, -13.6233], 'J/(mol*K)'),
        H298 = (77.9437, 'kJ/mol', '+|-', 5.88649),
        S298 = (218.47, 'J/(mol*K)', '+|-', 10.9983),
    ),
    shortDesc = """Fitted from cbs-qb3 calculations of CC1C2C=CC(C2)C1C, C1=CC2CC1CC2c1ccccc1, and C=CC1CC2C=CC1C2""",
    longDesc = 
"""
Fitted from cbs-qb3 calculations with AECs and BACs of 

CC1C2C=CC(C2)C1C (Mw122_S96)

C1=CC2CC1CC2c1ccccc1 (S_106_)

C=CC1CC2C=CC1C2 (Mw120_S99)

from thermo library multi-trays
...
""",
    thermo = ThermoData(
        Tdata = ([300, 400, 500, 600, 800, 1000, 1500], 'K'),
        Cpdata = ([-24.7008, -21.6266, -22.5442, -17.8136, -9.38078, -3.7056, -2.77927], 'J/(mol*K)'),
        H298 = (122.635, 'kJ/mol', '+|-', 0.0591707),
        S298 = (202.492, 'J/(mol*K)', '+|-', 6.39044),
    ),
    shortDesc = """Fitted from CBS-QB3 calculation""",
    longDesc = 
"""
Fitted from CBS-QB3 calculation for C=CC1C[C]2C=CC1CC2 by Hao-Wei Pang 12/15/2020.
